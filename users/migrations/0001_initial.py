    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.DecimalField(decimal_places=0, default=0, max_digits=15, verbose_name='اعتبار')),
                ...
                ('referrer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='referrals', to='users.user', verbose_name='معرف')),
